...
public class CommentController {
  ...
  public CommentWithBookNameDto add(@RequestBody CommentDto comment) {
  ...
  public CommentWithBookNameDto get(@PathVariable("id") long id) {
    return commentService.get(id);
  }

  @PutMapping("api/comment/{id}")
  public CommentWithBookNameDto update(@Valid @ModelAttribute("targetComment") CommentDto comment) {
